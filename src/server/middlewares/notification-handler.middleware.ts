...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'store.create': {
    roles: ['business-owner', 'store-administrator', 'product-manager', 'category-manager'],
    key: 'new-store-created',
    tenantPath: ['organization', 'store'],
    userPath: [],
  },
  'store.delete': {
    roles: ['business-owner', 'store-administrator', 'product-manager', 'category-manager'],
  ...
  'product.create': {
    roles: ['business-owner', 'store-administrator', 'product-manager', 'category-manager'],
    key: 'product-added',
    tenantPath: ['organization', 'store', 'category', 'product'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['business-owner', 'store-administrator', 'product-manager', 'category-manager'];
