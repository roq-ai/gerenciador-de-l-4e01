...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Gerenciador de loja virtual`}</title>

        <meta
          name="description"
          content="Experience the ease of online store management with Gerenciador de loja virtual. Create, manage, and organize products across multiple stores seamlessly."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563013544-824ae1b704d3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlY29tbWVyY2V8ZW58MHx8fHwxNjkyOTAyMjk3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the ease of online store management with Gerenciador de loja virtual. Create, manage, and organize products across multiple stores seamlessly.`}
            </Text>
            <Box
